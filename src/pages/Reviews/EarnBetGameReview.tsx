...
import waxCryptoImg from "../../Assets/images/cryptocurrency/wax.png";
...
// review images
import reviewImg1 from "../../Assets/images/reviews/10-earnbet-game/1-EarnBet-review.png";
import reviewImg2 from "../../Assets/images/reviews/10-earnbet-game/2-EarnBet-review.png";
import reviewImg3 from "../../Assets/images/reviews/10-earnbet-game/3-EarnBet-review.png";

// country flag
import { CN, GB, KR } from 'country-flag-icons/react/1x1';
...
const EarnBetGameReview = () => {
    const siteData = siteDatas[9];
                    ...
                    <div className="flex flex-col">
                                            ...
                                            <div className="flex flex-col xl:flex-row gap-3">
                                                <div className="flex flex-col gap-y-3">
                                                    <div className="flex flex-row items-start gap-x-3">
                                                        ...
                                                        <div className="w-[230px]">Dapp with welcome bonus</div>
                                                    </div>
                                                    <div className="flex flex-row items-start gap-x-3">
                                                        <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                                        <div className="w-[230px]">Win dividends from house profit</div>
                                                    </div>
                                                    <div className="flex flex-row items-start gap-x-3">
                                                        <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                                    ...
                                                    <div className="flex flex-row items-start gap-x-3">
                                                        <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                                        <div className="w-[230px]">Low house edge</div>
                                                    </div>
                                                </div>
                                                <div className="flex flex-col gap-y-3">
                                                    <div className="flex flex-row items-start gap-x-3">
                        ...
                        <div id="bonus-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                                ...
                                <div className="flex flex-row gap-x-5">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-sm text-gray-500">
                                            Blackjack players might want to play more
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div className="text-base">
                                        Unlike most casino Dapps, EarnBet gives you a welcome bonus of <a href="https://earnbet.io/?bonus=ez0826616207616750" target="_blank" rel="noreferrer" className="font-bold text-blue-600">$50, paid out in BTC.</a>
                                    </div>
                                    <div>
                                    ...
                                    {/*  */}
                                    <div>
                                        Do note that there are wagering requirements for this bonus:
                                    </div>
                                    ...
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            50x for all other games.
                                        </div>
                                    </div>
                                    <div>
                                        Although stricter requirements for blackjack are not unheard of, EarnBet's are a bit extreme.
                                    </div>
                                    <div>
                                        What's more, despite generous for a Dapp, EarnBet's welcome offer pales in comparison to most other cryptocurrency bonuses:
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            Its maximum amount is modest.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            The deposit limits are high for the value offered.
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        Every time you place real money bets, you earn BET Tokens, which are the Dapp version of a casino loyalty program, but better. Let's see why:
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            BET tokens give you a lower house edge on EarnBet's games, which can get as low as 0.5%.
                                        </div>
                                    </div>
                                    <div className="flex flex-row gap-x-2">
                                        <CheckOutlinedIcon style={{ color: "green" }} />
                                        <div>
                                            EarnBet pays 100% of its profit to BET token holders! The more tokens you have, the bigger your profit share. 
                                        </div>
                                    </div>
                                    <div>
                                        Besides BET Tokens and the welcome offer, there are also other promotions at EarnBet.
                                    </div>
                                    <div>
                                        For instance, you can participate in seasonal competitions and compete against other players on a weekly leaderboard offering cash prizes.
                                    </div>
                                    <div>
                                        Unfortunately, these promotions are a bit hard to find: you must go to EarnBet's blog to learn about them.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Welcome bonus</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Lower house edge</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Win a part of EarnBet's profit</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Stricter wagering requirements for blackjack</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Modest bonus with high deposit limit</div>
                                        </div>
                                    </div>
                        ...
                        <div id="lookFeel-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-row justify-center xl:justify-between">
                                <div className="flex flex-row gap-x-5">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-sm text-gray-500">
                                            You've got a real Dapp-er here
                                        </div>
                                    </div>
                                </div>
                                <div className="w-20 flex items-center justify-center relative">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        EarnBet is a neat and clean website, where you can easily find what you're looking for.
                                    </div>
                                    <div>
                                        When you access it, you're immediately presented with all the benefits of playing at this casino. This is a very transparent and user-friendly approach, allowing you to learn the ropes of this gambling Dapp.
                                    </div>
                                    <div>
                                        Before you sign up, this is what you can find as you scroll down on the homepage:
                                    </div>
                                    <div className="text-base">
                                        <Timeline position="right">
                                            <TimelineItem>
                                                ...
                                                <TimelineContent sx={{ py: '24px', px: 2 }}>
                                                    <div>
                                                        Some key numbers and promotional information.
                                                    </div>
                                                </TimelineContent>
                                            </TimelineItem>
                                            <TimelineItem>
                                                ...
                                                <TimelineContent sx={{ py: '24px', px: 2 }}>
                                                    <div>
                                                        The Dapp's benefits, as mentioned before.
                                                    </div>
                                                </TimelineContent>
                                            </TimelineItem>
                                            <TimelineItem>
                                    ...
                                    <div>
                                        You'll be glad to learn that the informational and promotional header will disappear as soon as you log in, giving you easy access to the games.
                                    </div>
                                    <div>
                                        You can also easily access the games from the drop-down menu next to EarnBet's logo at the top of the page.
                                    </div>
                                ...
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Neat and clean design</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                        ...
                        <div id="gameSelection-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        EarnBet offers a total of 6 different games, all developed in-house and 100% provably fair.
                                    </div>
                                    <div>
                                        All the games offered by EarnBet, which are 6 in total so far, are provably fair and developed in-house.
                                    </div>
                                    ...
                                    <div>
                                        All games have decent house edges, which are clearly displayed before you play the game. The one exception is the jackpot game, where you can see the grand prize instead.
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                        EarnBet's Jackpot
                                    </div>
                                    <div>
                                        The jackpot is a secondary game at EarnBet, where you can only participate if you have already wagered on the other games. Here's how it works:
                                    </div>
                                    <div className="text-base">
                                        <Timeline position="right">
                                            <TimelineItem>
                                                ...
                                                <TimelineContent sx={{ py: '24px', px: 2 }}>
                                                    <div>
                                                        Play 0.000001 BTC at any other game.
                                                    </div>
                                                </TimelineContent>
                                            </TimelineItem>
                                            <TimelineItem>
                                                ...
                                                <TimelineContent sx={{ py: '24px', px: 2 }}>
                                                    <div>
                                                        Stake an additional 0.00002 BTC to opt-in.
                                                    </div>
                                                </TimelineContent>
                                            </TimelineItem>
                                            <TimelineItem>
                                                ...
                                                <TimelineContent sx={{ py: '24px', px: 2 }}>
                                                    <div>
                                                        Spin and hit a 7,777,777 to receive a Golden Ticket Token.
                                                    </div>
                                                </TimelineContent>
                                            </TimelineItem>
                                        </Timeline>
                                    ...
                                    <div>
                                        Ticket holders can trade it for 90% of the jackpot's prize pool. 10% of the jackpot will always go to BET token winners.
                                    </div>
                                    <div>
                                        Ironically, you won't earn any new BET tokens when playing the jackpot.
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                        Other Games
                                    </div>
                                    <div>
                                        The other games on offer are dice, blackjack, baccarat, crash, and HiLo. 
                                    </div>
                                    <div>
                                        Don't expect high production values and impressive animations - these are internally-developed games that shine for their <span className="font-bold">low house edges (from 1.5% - 0.5%) and provable fairness</span>.
                                    </div>
                                    <div>
                                        Not only are the likes of NetEnt and Microgaming missing from EarnBet's portfolio, but there are also no slots at this Dapp.
                                    </div>
                                    <div>
                                        This is arguably a disadvantage, although we're not sure adding mainstream providers is the way to go. After all, not all casinos need to be behemoths with thousands of games, and gambling Dapps can shine with just a few low-key titles.
                                    </div>
                                    <div>
                                        EarnBet should focus instead on increasing the diversity of their provably fair portfolio.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">No slots</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="licensing-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        As stated before, all of EarnBets games are provably fair. This means that every bet gets recorded onto the blockchain - in this case, the WAX blockchain.
                                    </div>
                                    <div>
                                        If you dig around a bit - which we did for you - you can even find an independent report evaluating the brand. It attested EarnBet's fairness back when it was still called EOSBet.
                                    </div>
                                    <div>
                                        What's more, because EarnBet is a decentralized casino operating entirely on the blockchain, you won't have to go through invasive KYC checks! You can pay and play directly from your wallet and get your money at any time, no questions asked.
                                    </div>
                                    <div className="text-xl font-bold mt-5">
                                        In What Countries Is EarnBet Legal?
                                    </div>
                                    <div>
                                        Since EarnBet holds a <a href="https://licensing.gaming-curacao.com/validation/?lh=ff7b06bcb3a26358b67d93abf27d7b9f" target="_blank" rel="noreferrer" className="text-blue-600">Curaçao license</a>, it's only allowed to operate in countries where online gambling is not illegal nor heavily restricted.
                                    </div>
                                    <div>
                                        This is bad news if you're playing from countries such as the United Kingdom and the United States.
                                    </div>
                                    <div>
                                        Since it's a gambling Dapp, EarnBet does not currently block players from either country from accessing its website, but it still excludes them in their terms and conditions, so you may play at your own risk.
                                    </div>
                                    <div>
                                        Players from most other countries, however, are fully accepted. For instance, Australian players can play at EarnBet. Similarly, Canadians can also open an account and play with fiat money and cryptocurrencies alike.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">Restricted in some countries</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="payment-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        EarnBet only accepts payments with cryptocurrencies. While not surprising for a gambling Dapp, this can be a disadvantage for some players.
                                    </div>
                                    <div>
                                        At the moment you can pay with:
                                    </div>
                                    <div className="flex flex-wrap gap-3">
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            <CheckOutlinedIcon style={{ color: "green" }} />
                                    ...
                                    <div>
                                        Do note you are subject to <span className="font-bold">minimum withdrawal limits of 0.001 BTC</span> or equivalent.
                                    </div>
                                    <div>
                                        All payments are fast and hassle-free.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Nice amount of accepted currencies</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Fast and easy payments</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-y-3 px-5">
                                        <div className="font-bold text-red-900">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-red-300 w-[20px] h-[20px] rounded-full text-red-900 flex justify-center items-center mt-0.5">-</div>
                                            <div className="w-[230px]">No fiat currencies accepted</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="customer-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-10 mt-10">
                            ...
                            <div className="flex flex-col xl:flex-row gap-20 items-center xl:items-start">
                                <div className="flex flex-col gap-y-5">
                                    <div>
                                        If you have any questions, you can try to look up the answers on the FAQ page.
                                    </div>
                                    <div>
                                        In case your questions remain unanswered, you can contact EarnBet using the following channels:
                                    </div>
                                    <div className="flex flex-wrap gap-3">
                                        <div className="flex flex-row justify-center items-center gap-x-2 rounded-full bg-green-200 pl-2 pr-3">
                                            <CheckOutlinedIcon style={{ color: "green" }} />
                                    ...
                                    <div>
                                        The Dapp has 8 official Telegram accounts across several languages.
                                    </div>
                                    <div>
                                        It's also active on <a href="https://twitter.com/earnbetcasino" target="_blank" rel="noreferrer" className="text-blue-600">Twitter</a> and <a href="https://gitlab.com/EOSBetCasino" target="_blank" rel="noreferrer" className="text-blue-600">Gitlab</a>.
                                    </div>
                                </div>
                                <div className="flex flex-col min-w-[300px] border rounded-xl gap-y-5">
                                    <div className="text-xl font-bold bg-gray-200 px-5 py-3 rounded-t-xl">
                                    ...
                                    <div className="flex flex-col gap-y-3 px-5">
                                        ...
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Email support</div>
                                        </div>
                                        <div className="flex flex-row justify-between items-start">
                                            <div className="bg-green-300 w-[20px] h-[20px] rounded-full text-green-900 flex justify-center items-center mt-0.5">+</div>
                                            <div className="w-[230px]">Active social media channels</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center py-5">
                                        <Button
                        ...
                        <div id="faq-section" className="part-section bg-white flex flex-col rounded-xl p-5 gap-y-5 mt-10">
                            ...
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                >
                                    1. Can I really earn a passive income with EarnBet?
                                </div>
                                {openFAQ1 &&
                                    <div className="text-black mt-5">
                                        Yes, you can. That is, if you earn enough Bet Tokens and the website makes enough money. So get the word out.
                                    </div>
                                }
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                >
                                    2. Does EOSBet still exist?
                                </div>
                                {openFAQ2 &&
                                    <div className="text-black mt-5">
                                        Yes, you can still find the former website at eosbet.io. The main reason for the change was to become friendlier for other currencies.
                                    </div>
                                }
                            </div>
                            <div className="flex flex-col border-b border-gray-400 px-2 py-2">
                                ...
                                >
                                    3. Will it be possible to earn tokens forever?
                                </div>
                                {openFAQ3 &&
                                    <div className="text-black mt-5">
                                        No, EarnBet is currently running a token burning program. The tokens that are bought back, will be burned and can never get back in circulation. As time goes by, the idea is to burn more tokens.
                                    </div>
                                }
                            </div>
                        </div>
...
export default EarnBetGameReview;